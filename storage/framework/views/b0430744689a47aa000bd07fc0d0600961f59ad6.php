...
<head>
    ...
    <link rel="icon" type="svg" href="<?php echo e(asset('img/favicon.svg')); ?>">

    <!-- Bootstrap CSS -->
    <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.5.0/css/bootstrap.min.css" integrity="sha384-9aIt2nRpC12Uk9gS9baDl411NQApFmC26EwAOH8WgZl5MYYxFfc+NcPb1dKGj7Sk" crossorigin="anonymous">
    <link rel="stylesheet" href="<?php echo e(asset('css/abilities.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('css/bottomer.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('css/effect11.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('css/fontface.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('css/gamehead.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('css/gradientmove.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('css/jumbo.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('css/loadingspin.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('css/master.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('css/navbot.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('css/photogrid.css')); ?>">
...
<?php /**PATH R:\Clone\net-erb\resources\views/layout/main.blade.php ENDPATH**/ ?>